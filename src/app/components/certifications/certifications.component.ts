            ...
            <div class="rounded-lg flex">
              <div class="flex-none">
                <span class="relative flex shrink-0 overflow-hidden rounded-full border border-gray-300 dark:border-gray-600 size-12 m-auto bg-white dark:bg-gray-100">
                  ...
                  <span *ngIf="!cert.imageUrl" class="flex h-full w-full items-center justify-center rounded-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-100">{{ cert.name.charAt(0) }}</span>
                </span>
              </div>
              <div class="grow ml-4 items-center flex-col">
                <div class="flex flex-col">
                  <div class="flex items-center justify-between gap-x-2 text-base">
                    ...
                    <div class="text-xs tabular-nums text-gray-500 dark:text-gray-400 text-right hidden sm:block">Issued {{ cert.issueDate }}</div>
                  </div>
                  <div class="text-xs tabular-nums text-gray-500 dark:text-gray-400 text-left block sm:hidden mb-1">Issued {{ cert.issueDate }}</div>
