  ...
  template: `
    <div class="py-8">
      <div class="text-center mb-12">
        ...
        <p class="text-lg text-gray-600 max-w-xl mx-auto">Explore all my blog posts about web development, AWS, and various technical topics.</p>
      </div>
        ...
        <div class="flex items-center flex-col gap-4">
          ...
          @if(activeTag()) {
            <div class="flex items-center gap-2">
              ...
              <span class="inline-flex items-center rounded-md bg-black text-white px-3 py-1 text-sm font-medium">
                {{ activeTag() }}
                <button
      ...
      <div class="text-center mt-12 pt-8 border-t border-gray-200">
        <p class="text-gray-600 mb-4">Found {{ sortedPosts().length }} blog posts</p>
        <a [routerLink]="['/']" class="inline-flex items-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 transition-colors">
