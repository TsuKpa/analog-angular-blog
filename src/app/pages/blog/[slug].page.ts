    ...
    @if (isLoading()) {
      <div class="py-8 animate-pulse">
        <article>
          ...
          <!-- Loading text -->
          <div class="flex items-center justify-center mt-8 text-gray-500 dark:text-gray-400">
              ...
              <div class="flex flex-wrap gap-2">
                @for (tag of post.attributes.tags; track tag) {
                  <a
                    ...
                    class="text-xs bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100 hover:bg-gray-300 dark:hover:bg-gray-700 px-2 py-1 rounded transition-colors"
                  >#{{ tag }}</a>
                }
              </div>
